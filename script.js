...
console.log("Current Theme:", example.config.settings.theme); // Yaha jo "appConfig" object ke andr jo "settings" wala nested object ko print krwa rhe hai, jo practical me kaha gya tha.
